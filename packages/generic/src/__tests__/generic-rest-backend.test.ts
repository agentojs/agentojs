...
import { GenericRESTBackend, GenericBackendNotImplementedError } from '../generic-rest-backend.js';
...
describe('GenericRESTBackend — constructor', () => {
  it('creates an instance', () => {
    const backend = createBackend();
    expect(backend).toBeInstanceOf(GenericRESTBackend);
  });
...
describe('GenericRESTBackend — auth headers', () => {
...
describe('GenericRESTBackend — searchProducts', () => {
...
describe('GenericRESTBackend — getProduct', () => {
...
describe('GenericRESTBackend — collections', () => {
...
describe('GenericRESTBackend — cart', () => {
...
describe('GenericRESTBackend — shipping', () => {
...
describe('GenericRESTBackend — checkout', () => {
  ...
  it('selectPaymentSession throws NotImplementedError', async () => {
    ...
    ).rejects.toThrow(GenericBackendNotImplementedError);
  });
...
describe('GenericRESTBackend — orders', () => {
...
describe('GenericRESTBackend — regions', () => {
...
describe('GenericRESTBackend — healthCheck', () => {
...
describe('GenericRESTBackend — custom endpoints', () => {
...
describe('GenericRESTBackend — custom field mapping', () => {
...
describe('GenericRESTBackend — error handling', () => {
  ...
  it('GenericBackendNotImplementedError has correct name', () => {
    const error = new GenericBackendNotImplementedError('testMethod');
    expect(error.name).toBe('GenericBackendNotImplementedError');

/**
 * WooCommerceBackend — WooCommerce REST + Store API implementation of CommerceBackend.
 *
...
export interface WooCommerceBackendConfig {
  baseUrl: string;
  consumerKey: string;

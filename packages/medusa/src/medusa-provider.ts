/**
 * MedusaProvider — Medusa.js v2 REST API implementation of CommerceProvider.
 *
...
export class MedusaProvider implements CommerceProvider {
  private readonly baseUrl: string;
  private readonly apiKey: string;
  private readonly regionId: string;
  private cachedRegionId: string | null = null;

  constructor(cfg: MedusaProviderConfig) {
